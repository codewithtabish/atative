...
const opportunities = [
  {
    ...
    description:
      "A paid article or content collaboration created around an agreed promotional objective. Sponsored content should be clearly identified for readers.",
  },
  {
    icon: Sparkles,
    title: "Product or tool promotion",
    description:
      "Promotional opportunities for relevant software, AI tools, apps, products, and services may be discussed depending on fit.",
  },
  {
    icon: Megaphone,
  ...
  },
  {
    ...
    description:
      "Newsletter promotions may be available depending on the campaign, format, timing, and available inventory.",
  },
  {
    icon: Handshake,
...
const process = [
  {
    ...
    description:
      "Contact Alentah and explain what you want to promote, who it is for, and what you have in mind.",
  },
  {
    number: "02",
    title: "We review it",
    description:
      "Alentah reviews the request for relevance, quality, audience fit, and suitability.",
  },
  {
    number: "03",
          ...
          <div className="mx-auto max-w-5xl py-20 sm:py-24 lg:py-32">
            <div className="max-w-3xl">
              ...
              <p className="mt-7 max-w-2xl text-pretty text-lg leading-8 text-muted-foreground sm:text-xl">
                Alentah works with relevant brands, products, tools, services, creators, startups,
                and organizations on promotional opportunities that fit our technology-focused
                publication.
              </p>
              ...
              <p className="mt-5 max-w-xl text-sm leading-6 text-muted-foreground">
                Every advertising and partnership request is subject to review and approval by
                Alentah. An inquiry does not guarantee acceptance, publication, or any particular
                result.
              </p>
            </div>
          </div>
              ...
              <div className="grid gap-px overflow-hidden rounded-2xl border border-border bg-border sm:grid-cols-2">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Talk directly with the Alentah team rather than relying only on automated advertising systems.",
                  },
                ].map((item) => {
          ...
          <div className="grid gap-12 py-16 sm:py-20 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20 lg:py-24">
            <div>
              ...
              <p className="mt-5 text-base leading-7 text-muted-foreground">
                ...
                relevance, quality, audience fit, and Alentah&apos;s editorial standards.
              </p>
            </div>
            ...
            <div className="grid content-start gap-x-8 gap-y-3 sm:grid-cols-2">
              {audiences.map((audience) => (
                <div
                  key={audience}
                  className="flex items-start gap-3 border-b border-border/70 py-3"
                >
            ...
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
              ...
              <div>
                <p className="text-base leading-7 text-muted-foreground">
                  Alentah is particularly interested in products, services, and projects connected
                  to technology and emerging ideas. Relevance is important, but it does not
          ...
          <div className="py-16 sm:py-20 lg:py-24">
            ...
            <div className="mt-7 flex items-start gap-3 rounded-xl border border-primary/20 bg-primary/5 p-4 text-sm leading-6">
              ...
              <p>
                ...
                are agreed directly with Alentah for approved opportunities.
              </p>
            </div>
          </div>
        </Container>
          ...
          <div className="py-16 sm:py-20 lg:py-24">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-6 grid gap-6 text-base leading-7 text-muted-foreground md:grid-cols-2">
                ...
                <p>
                  Alentah may decline promotional requests that do not fit its audience, quality
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-3 text-base leading-7 text-muted-foreground">
                    When content is sponsored or paid for, Alentah may identify it with clear labels
            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
              ...
              <div className="space-y-5 text-base leading-7 text-muted-foreground">
                <p>
                  ...
                  advertisements on Alentah through its advertising platform.
                </p>

                <p>
                  Direct advertising inquiries on this page are not requests to control or purchase
                  Google AdSense advertisements. Alentah does not manually negotiate each AdSense
                  advertisement through this page.
                </p>

                <p>
                  If you want to discuss a direct promotional campaign, sponsored content
                  opportunity, or commercial partnership with Alentah, contact the team directly.
                </p>
              </div>
            </div>
          </div>
        ...
        <Container>
          <div className="grid gap-10 py-16 sm:py-20 lg:grid-cols-2 lg:gap-20 lg:py-24">
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-muted-foreground">
                Alentah may decline promotions that are irrelevant to its audience, misleading,
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_auto] lg:items-end lg:gap-20">
              <div className="max-w-3xl">
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
                  ...
                  good fit for Alentah, get in touch and tell us what you have in mind.
                </p>
              ...
              <div className="w-full rounded-2xl border border-border bg-background p-6 sm:p-7 lg:w-[360px]">
                ...
                <div className="mt-6 flex flex-col gap-2 sm:flex-row lg:flex-col">
                  ...
                  <Button asChild variant="outline">
                    <a href="https://wa.me/923169000919" target="_blank" rel="noopener noreferrer">
                      <MessageCircle className="size-4" aria-hidden="true" />
                      WhatsApp us
                    </a>
                  </Button>
      ...
      <section>
        <Container>
          <div className="flex flex-col gap-4 py-10 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
            ...
            <p>Commercial partnerships are subject to Alentah&apos;s review and approval.</p>
          </div>
        </Container>
      </section>
    </main>
