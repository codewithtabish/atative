        ...
        <div className="mx-auto max-w-5xl py-20 sm:py-24 lg:py-32">
          <div className="w-full">
            ...
            <p className="mt-7 max-w-2xl text-pretty text-lg leading-8 text-muted-foreground sm:text-xl">
              Alentah works with relevant brands, products, tools, services, creators, startups, and
              organizations on promotional opportunities that fit our technology-focused
              publication.
            </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div>
              <p className="text-base leading-7 text-muted-foreground">
                Alentah is particularly interested in products, services, and projects connected to
          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
            ...
            <div className="space-y-5 text-base leading-7 text-muted-foreground">
              ...
              <p>
                ...
                or commercial partnership with Alentah, contact the team directly.
              </p>
            </div>
          </div>
        </div>
