...
import { EditorTableSkeleton } from "@/components/(app)/(dashbaord)/editor/editor-table-skeleton";
import UpdateEditorForm from "@/components/(app)/(dashbaord)/editor/update-editor-form";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
